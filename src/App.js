    ...
    <div className="font-outfit">
      ...
      <section className="flex wrap h-screen mr-[16vw] ml-[16vw]">
        ...
        <div className="mt-52 flex-auto w-64 wrap">
          ...
          <h1 className="text-5xl">Change your<br />Digital Experience</h1>
          <p className="mt-4">Suspendisse sem neque, auctor a elementum ut,
            <br />
